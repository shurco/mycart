...
We take the security of myCart code, software, and cloud platform very seriously. If you believe you have found a security vulnerability in myCart, we encourage you to let us know right away. We will investigate all legitimate reports and do our best to quickly fix the problem.
...
- Where the security issue exists (ie. myCart, infrastructure, etc.)
